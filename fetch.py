#!/usr/bin/env python3
"""
Recupero codici sconto GioiaPura da shopilo.it
Sursa: https://shopilo.it/negozi/gioiapura.it
"""
...
SHOPILO_URL = "https://shopilo.it/negozi/gioiapura.it"
STORE_NAME = "GioiaPura"


def fetch_coupons(url=SHOPILO_URL):
    """Restituisce la lista dei coupon attivi per GioiaPura da shopilo.it"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-it/codice-sconto-gioiapura)"
    }
    try:
